...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/d'creativ.png">
                ...
                <div class="add-edit-product-form">
                    <form method="POST" action="aksi_tambah.php" enctype="multipart/form-data">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12 mb-30"><input class="form-control" name="nama_produk" type="text" placeholder="Product Name / Title*"></div>
                                <div class="col-lg-6 col-12 mb-30"><input class="form-control" name="harga_produk" type="text" placeholder="Product Price*"></div>
                                <div class="col-12 mb-30"><textarea class="form-control" name="keterangan" placeholder="Product Description*"></textarea></div>
