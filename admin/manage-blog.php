...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/d'creativ New Logo ( Transparent Orange) (1).png">
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="header-logo col-auto">
                        <a href="index.html">
                            ...
                            <img src="assets/images/logo/logo.png" class="logo-light" alt="">
                        </a>
                    ...
                    <ul>
                        <li class="has-sub-menu"><a href="#"><i class="ti-home"></i> <span>Dashboard</span></a>
                            <ul class="side-header-sub-menu">
                                <li><a href="main.php"><span>E-commerce (Default)</span></a></li>
                            </ul>
                        </li>


                        <li class="has-sub-menu"><a href="index.php"><i class="ti-shopping-cart"></i> <span>E-commerce</span></a>
                            <ul class="side-header-sub-menu">
                                <li><a href="add-product.php"><span>Add Product</span></a></li>
                                <li><a href="edit-product.php"><span>Edit Produk</span></a></li>
                        ...
                        <li class="has-sub-menu"><a href="index.php"><i class="fa fa-book"></i> <span>Training</span></a>
                            <ul class="side-header-sub-menu">
                                <li><a href="add-Training.php"><span>Add Training</span></a></li>
                                <li><a href="data-Training.php"><span>Data Training</span></a></li>
                                <li><a href="Approvel-Training.php"><span>Approvel Training</span></a></li>
                            </ul>
                        </li>

                        <li class="has-sub-menu"><a href="index.php"><i class="fa fa-rss-square"></i> <span>Blog</span></a>
                            <ul class="side-header-sub-menu">
                                <li><a href="add-BLog.php"><span>Add BLog</span></a></li>
                                <li><a href="manage-BLog.php"><span>Data BLog</span></a></li>
            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>Blog <span>/ Manage Blog</span></h3>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-vertical-middle">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                $data = mysqli_query($koneksi, "select * from tb_artikel");
                                while ($d = mysqli_fetch_array($data)) {
                                ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><img src="assets/images/blog/<?php echo $d['gambar']; ?>" alt="" style="width:150px"></td>
                                        <td><?php echo $d['sub_artikel']; ?></td>
                                        <td><?php echo $d['judul']; ?></td>
                                        <td><?php echo $d['link_art']; ?></td>
                                        ...
                                        <td>
                                            <div class="table-action-buttons">
                                                ...
                                                <a class="edit button button-box button-xs button-info" href="edit-product.php"><i class="zmdi zmdi-edit"></i></a>
                                                <a class="delete button button-box button-xs button-danger" href="hapus-blog.php"><i class="zmdi zmdi-delete"></i></a>
